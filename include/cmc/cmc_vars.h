...
_EXTERN_ long N_STAR_DIM, N_STAR_DIM_OPT, N_BIN_DIM, N_BIN_DIM_OPT, T_MAX_COUNT, MASS_PC_COUNT, STELLAR_EVOLUTION, TIDAL_TREATMENT, RTIDAL_COEFF, SS_COLLISION, TIDAL_CAPTURE, BH_CAPTURE, TC_POLYTROPE, STAR_AGING_SCHEME, PREAGING, NO_MASS_BINS, NO_BSE_NATAL_KICK_ARRAY, NO_BSE_FPRIMC_ARRAY, NO_BSE_QCRIT_ARRAY;
